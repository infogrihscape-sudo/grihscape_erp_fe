...
export const labourApi = {
  ...
  updateLabourer: (projectId: string, id: string, data: any) => api.put(`/labour/${projectId}/labourers/${id}`, data),
  toggleLabourer: (projectId: string, id: string) => api.patch(`/labour/${projectId}/labourers/${id}/toggle`),
